    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("registration-complete")} style={{ backgroundColor: "#FA4A0C", padding: 10, borderRadius: 10, marginBottom: 20, minHeight: 50, display: "flex", justifyContent: "center", alignItems: "center", marginHorizontal: 40 }}>
